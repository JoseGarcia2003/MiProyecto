...
public class Libreria extends javax.swing.JFrame {
    ...
    if (ConexionBD.agregarProducto(producto)) {
    ...
    if (ConexionBD.eliminarProducto(codigo)) {
    ...
    // Llamar al método para obtener todos los productos de la base de datos
    ArrayList<Producto> productos = ConexionBD.obtenerProductos();

    // Mostrar los productos en una tabla o lista en tu interfaz
